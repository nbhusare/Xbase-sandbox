...
class RunWebSocketServer {
	...
	def static void main(String[] args) throws InterruptedException, IOException {
		...
		var ServerSocket serverSocket = new ServerSocket(5007)
	...
	def static package <T> Launcher<T> createSocketLauncher(Object localService, Class<T> remoteInterface,
		ExecutorService executorService, Function<MessageConsumer, MessageConsumer> wrapper, InputStream inputStream,
