...
@after {
	...
	(
		...
		{
			$current = $this_XInExpression_0.current;
			afterParserOrEnumRuleCall();
		}
		(
			(
...
entryRuleXInExpression returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getXInExpressionRule()); }
	iv_ruleXInExpression=ruleXInExpression
	{ $current=$iv_ruleXInExpression.current; }
	EOF;

// Rule XInExpression
ruleXInExpression returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleOpIn returns [String current=null]:
	{ newCompositeNode(grammarAccess.getOpInRule()); }
	iv_ruleOpIn=ruleOpIn
	{ $current=$iv_ruleOpIn.current.getText(); }
	EOF;

// Rule OpIn
ruleOpIn returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
