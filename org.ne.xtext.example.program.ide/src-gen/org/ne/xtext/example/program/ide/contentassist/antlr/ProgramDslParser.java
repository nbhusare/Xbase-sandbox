 ...
 */
package org.ne.xtext.example.program.ide.contentassist.antlr;
...
import org.ne.xtext.example.program.ide.contentassist.antlr.internal.InternalProgramDslParser;
import org.ne.xtext.example.program.services.ProgramDslGrammarAccess;

public class ProgramDslParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalProgramDslParser createParser() {
		InternalProgramDslParser result = new InternalProgramDslParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getProgramAccess().getBodyAssignment(), "rule__Program__BodyAssignment");
					put(grammarAccess.getBodyAccess().getExpressionsAssignment_1_0(), "rule__Body__ExpressionsAssignment_1_0");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalProgramDslParser typedParser = (InternalProgramDslParser) parser;
