...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getXIfExpressionAccess().getGroup_3(), "rule__XIfExpression__Group_3__0");
			...
			builder.put(grammarAccess.getXInExpressionAccess().getGroup(), "rule__XInExpression__Group__0");
			builder.put(grammarAccess.getXInExpressionAccess().getGroup_1(), "rule__XInExpression__Group_1__0");
			builder.put(grammarAccess.getXInExpressionAccess().getGroup_1_0(), "rule__XInExpression__Group_1_0__0");
			builder.put(grammarAccess.getXInExpressionAccess().getGroup_1_0_0(), "rule__XInExpression__Group_1_0_0__0");
			...
			builder.put(grammarAccess.getModelAccess().getBodyAssignment(), "rule__Model__BodyAssignment");
			builder.put(grammarAccess.getXIfExpressionAccess().getIfAssignment_2(), "rule__XIfExpression__IfAssignment_2");
			builder.put(grammarAccess.getXIfExpressionAccess().getThenAssignment_3_1(), "rule__XIfExpression__ThenAssignment_3_1");
			...
			builder.put(grammarAccess.getXInExpressionAccess().getFeatureAssignment_1_0_0_1(), "rule__XInExpression__FeatureAssignment_1_0_0_1");
			builder.put(grammarAccess.getXInExpressionAccess().getRightOperandAssignment_1_1(), "rule__XInExpression__RightOperandAssignment_1_1");
